...
class SDFBasedLiquid(TFModel):
    ...
    def __init__(self):
        ...
        self.initial_density[:, size[-2] * 6 // 8 : size[-2] * 8 // 8 - 2, size[-1] * 2 // 8 : size[-1] * 6 // 8, :] = 1
        ...
        self.add_field("Mask Before", lambda: self.liquid.mask_before)
        self.add_field("Mask After", lambda: self.liquid.mask_after)
