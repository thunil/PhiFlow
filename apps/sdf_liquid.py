...
class SDFBasedLiquid(FieldSequenceModel):
    ...
    def __init__(self):
        ...
        self.liquid = world.SDFLiquid(domain=domain, density=self.initial_density, velocity=self.initial_velocity, gravity=-0.5)
    ...
    def action_reset(self):
        ...
        self.liquid._sdf, _ = extrapolate(self.initial_velocity, particle_mask, distance=30)
